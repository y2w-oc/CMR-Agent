...
class KittiConfiguration:
    ...
    def __init__(self, data_root=None):
        print("KITTI Dataset Configuration...")
        # <----------- dataset configuration ---------->
        self.dataset_root = '/home/yao/workspace/I2P/kitti/' if data_root is None else data_root
        self.data_velodyne = 'data_odometry_velodyne_NWU/'
